    ...
    return (
        <ClickSpark sparkColor="#7b68ee" sparkSize={12} sparkRadius={100} sparkCount={10}>
            <div className="min-h-screen">
                {/* ─── NAV ─── */}
                <nav
                    className="fixed top-0 left-0 right-0 z-50 backdrop-blur-md bg-[#050510]/70 border-b border-white/5">
                ...
                <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
                    ...
                    <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
                        <div
                            className="backdrop-blur-xl bg-white/[0.04] border border-white/10 rounded-3xl p-10 md:p-16">
                            <SplitText
                                text="Plot the Next Ridge Line"
                            ...
                            <div className="mt-6">
                                <BlurText
                                    text="Multi-day routes with elevation, water sources, and refuge huts on one map"
                            ...
                            <div className="mt-8 flex flex-wrap justify-center gap-4">
                                {[
                                    ...
                                    <div key={stat.label}
                                         className="px-5 py-2 rounded-full bg-white/[0.06] border border-white/10 text-sm">
                    ...
                    <div className="relative z-10 max-w-6xl mx-auto px-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            {[
                                {
                                    icon: '&#9672;',
                                    title: 'Drafted Routes',
                                    desc: 'Pick a start and a summit; legs draw against contour lines and reroute when storms move in'
                                },
                                {
                                    icon: '&#9788;',
                                    title: 'Offline Maps',
                                    desc: 'Download entire regions. Navigate without signal, sync when back online'
                                },
                                {
                                    icon: '&#9733;',
                                    title: 'Group Sync',
                                    desc: 'Real-time position sharing. See your group on the map, always'
                                },
                            ].map((feature) => (
                                <SpotlightCard
                                    key={feature.title}
                ...
                <section id="tours" className="py-24 bg-[#08081a]">
                    <div className="max-w-6xl mx-auto px-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 justify-items-center">
                            {[
                                {
                                    title: 'Alpine Peaks Trail',
                                    gradient: 'linear-gradient(135deg, #667eea, #764ba2)',
                                    caption: '12 days · Advanced'
                                },
                                {
                                    title: 'Coastal Sunset Route',
                                    gradient: 'linear-gradient(135deg, #f093fb, #f5576c)',
                                    caption: '5 days · Moderate'
                                },
                                {
                                    title: 'Rainforest Canopy',
                                    gradient: 'linear-gradient(135deg, #4facfe, #00f2fe)',
                                    caption: '8 days · Beginner'
                                },
                            ].map((tour) => (
                                <TiltedCard
                                    key={tour.title}
                ...
                <section className="relative py-32 overflow-hidden">
                    ...
                    <div className="relative z-10 text-center px-6">
                        ...
                        <p className="text-white/50 text-lg mb-10 max-w-lg mx-auto">
                            50,000+ guides and walkers already plan their seasons here
                        </p>
                        <StarBorder
                            as="a"
            ...
            <span className="text-white/30 text-sm">
              Built with{' '}
                <a href="https://reactbits.dev" className="text-white/50 hover:text-white transition-colors"
